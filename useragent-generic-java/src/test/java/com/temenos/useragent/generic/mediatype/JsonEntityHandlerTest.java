...
public class JsonEntityHandlerTest {

    private JsonEntityHandler entityHandler;
    ...
    public void testGetValueForNestedProperty() {
        assertEquals("INCORP/CUS*200 FROM 66052 NOT RECEIVED", entityHandler.getValue("OverrideGroup(0)/Override"));
        assertEquals("MEMORANDUM/CUS*200 FROM 66052 NOT RECEIVED", entityHandler.getValue("OverrideGroup(1)/Override"));
        ...
        assertEquals("EMAIL", entityHandler.getValue("CommTypeGroup(0)/PrefChannel"));
        assertEquals("2", entityHandler.getValue("CommTypeGroup(1)/CommType"));
        assertEquals("MOBILE", entityHandler.getValue("CommTypeGroup(1)/PrefChannel"));
    }

    @Test
    public void testGetValueForDeepNestedProperty() {
        assertEquals("94086 Main street", entityHandler.getValue("AddressGroup(0)/AddressSubGroup(0)/Address"));
    ...
    public void testGetValueForMixedNestedProperty() {
        assertEquals("2486 Main street",
                entityHandler.getValue("EmploymentStatusGroup(0)/EmployersAddSubGroup(0)/EmployersAdd"));
        assertEquals("USD", entityHandler.getValue("EmploymentStatusGroup(0)/CustomerCurrency"));
        assertEquals("1222 Kings road",
                entityHandler.getValue("EmploymentStatusGroup(1)/EmployersAddSubGroup(0)/EmployersAdd"));
        assertEquals("220 Kings road",
    ...
    public void testGetCountForDeepNestedProperty() {
        ...
        assertEquals(2, entityHandler.getCount("AddressGroup(0)/AddressSubGroup"));
    }

    @Test
    public void testGetCountForMixedNestedProperty() {
        assertEquals(2, entityHandler.getCount("EmploymentStatusGroup"));
        assertEquals(1, entityHandler.getCount("EmploymentStatusGroup(0)/EmployersAddSubGroup"));
        assertEquals(2, entityHandler.getCount("EmploymentStatusGroup(1)/EmployersAddSubGroup"));
    }
    ...
    public void testSetValueForExistingNestedProperty() {
        ...
        assertEquals("MAIL", entityHandler.getValue("CommTypeGroup(0)/PrefChannel"));
        ...
        assertEquals("EMAIL", entityHandler.getValue("CommTypeGroup(1)/PrefChannel"));
    }

    @Test
    public void testSetValueForExistingDeepNestedProperty() {

        entityHandler.setValue("AddressGroup(0)/AddressSubGroup(0)/Address", "foo");
        assertEquals("foo", entityHandler.getValue("AddressGroup(0)/AddressSubGroup(0)/Address"));
        entityHandler.setValue("AddressGroup(0)/AddressSubGroup(0)/LanguageCode", "de");
        assertEquals("de", entityHandler.getValue("AddressGroup(0)/AddressSubGroup(0)/LanguageCode"));
        entityHandler.setValue("AddressGroup(0)/AddressSubGroup(1)/Address", "bar");
        assertEquals("bar", entityHandler.getValue("AddressGroup(0)/AddressSubGroup(1)/Address"));
        entityHandler.setValue("AddressGroup(0)/AddressSubGroup(1)/LanguageCode", "en");
        assertEquals("en", entityHandler.getValue("AddressGroup(0)/AddressSubGroup(1)/LanguageCode"));
    ...
    public void testSetValueForNewNestedPropertyWithValidIndex() {
        ...
        assertEquals("MAIL", entityHandler.getValue("CommTypeGroup(2)/PrefChannel"));
        // to make sure the existing properties untouched
        assertEquals("1", entityHandler.getValue("CommTypeGroup(0)/CommType"));
        assertEquals("EMAIL", entityHandler.getValue("CommTypeGroup(0)/PrefChannel"));
        assertEquals("2", entityHandler.getValue("CommTypeGroup(1)/CommType"));
    ...
    public void testSetValueForNewDeepNestedPropertyWithValidIndex() {
        entityHandler.setValue("AddressGroup(0)/AddressSubGroup(2)/Address", "foo");
        assertEquals("foo", entityHandler.getValue("AddressGroup(0)/AddressSubGroup(2)/Address"));

        entityHandler.setValue("AddressGroup(1)/AddressSubGroup(0)/LanguageCode", "de");
        assertEquals("de", entityHandler.getValue("AddressGroup(1)/AddressSubGroup(0)/LanguageCode"));
    }

    @Test
    public void testSetValueForNewDeepNestedPropertyWithInvalidIndex() {
        try {
            entityHandler.setValue("AddressGroup(1)/AddressSubGroup(3)/Address", "bar");
            fail("IllegalArgumentException should have thrown");
        } catch (Exception e) {
            assertTrue(e instanceof IllegalArgumentException);
        }
        ...
        try {
            entityHandler.setValue("AddressGroup(0)/AddressSubGroup(3)/LanguageCode", "en");
            fail("IllegalArgumentException should have thrown");
        } catch (Exception e) {
            assertTrue(e instanceof IllegalArgumentException);
        }
    ...
    public void testSetValueForNewMixedNestedPropertyWithValidIndex() {
        entityHandler.setValue("EmploymentStatusGroup(0)/EmployersAddSubGroup(1)/EmployersAdd", "foo");
        assertEquals("foo", entityHandler.getValue("EmploymentStatusGroup(0)/EmployersAddSubGroup(1)/EmployersAdd"));

        entityHandler.setValue("EmploymentStatusGroup(2)/CustomerCurrency", "SGD");
        assertEquals("SGD", entityHandler.getValue("EmploymentStatusGroup(2)/CustomerCurrency"));

        entityHandler.setValue("EmploymentStatusGroup(2)/EmployersAddSubGroup(0)/EmployersAdd", "bar");
        assertEquals("bar", entityHandler.getValue("EmploymentStatusGroup(2)/EmployersAddSubGroup(0)/EmployersAdd"));
    ...
    public void testSetValueForNewMixedNestedPropertyWithInValidIndex() {
        try {
            entityHandler.setValue("EmploymentStatusGroup(0)/EmployersAddSubGroup(2)/EmployersAdd", "foo");
            fail("IllegalArgumentException should have thrown");
        } catch (Exception e) {
            assertTrue(e instanceof IllegalArgumentException);
        }
        ...
        try {
            entityHandler.setValue("EmploymentStatusGroup(3)/CustomerCurrency", "SGD");
            fail("IllegalArgumentException should have thrown");
        } catch (Exception e) {
            assertTrue(e instanceof IllegalArgumentException);
        }
    ...
    public void testRemovePropertyAtTheTop() {
        ...
        assertNull(entityHandler.getValue("EmploymentStatusGroup(0)/EmployersAddSubGroup(0)/EmployersAdd"));
    }

    @Test
    public void testRemoveNonExistentProperty() throws Exception {
        JSONObject orignalObj = new JSONObject(IOUtils.toString(entityHandler.getContent()));
        entityHandler.remove("foo");
        JSONObject nonExistentPropertyRemovedObject = new JSONObject(IOUtils.toString(entityHandler.getContent()));
    ...
    public void testRemoveArrayProperty() {
        ...
        entityHandler.remove("EmploymentStatusGroup(1)/EmployersAddSubGroup(0)");
        assertEquals("220 Kings road",
                entityHandler.getValue("EmploymentStatusGroup(1)/EmployersAddSubGroup(0)/EmployersAdd"));

        entityHandler.remove("EmploymentStatusGroup(1)");
        assertNull(entityHandler.getValue("EmploymentStatusGroup(1)/EmployersAddSubGroup(0)/EmployersAdd"));
    }
    ...
    public void testSetSimpleValueWithNoEntity() throws Exception {
        entityHandler = new JsonEntityHandler();
    ...
    public void testSetValueForNewlyCreatedNestedProperty() {
        ...
        entityHandler.setValue("contact(1)/type", "personal1");
        entityHandler.setValue("contact(1)/status", "active1");

        assertEquals("personal", entityHandler.getValue("contact(0)/type"));
        assertEquals("active", entityHandler.getValue("contact(0)/status"));
        assertEquals("personal1", entityHandler.getValue("contact(1)/type"));
        assertEquals("active1", entityHandler.getValue("contact(1)/status"));
        assertNull(entityHandler.getValue("contact(2)/type"));
        assertNull(entityHandler.getValue("contact(3)/foo"));
    }
    ...
    private void initEntityHandler(String jsonFileName) {
        entityHandler = new JsonEntityHandler();
        entityHandler.setContent(JsonEntityHandlerTest.class.getResourceAsStream(jsonFileName));
    }
